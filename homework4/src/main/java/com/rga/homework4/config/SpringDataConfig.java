package com.rga.homework4.config;
...
@Configuration
@EnableJpaRepositories("com.rga.homework4.repository")
@EnableTransactionManagement
@ComponentScan("com.rga.homework4")
public class SpringDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("com.rga.homework4.domain");
